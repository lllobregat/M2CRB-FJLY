    ...
    public Site getInfoSite(short idSite) {
        ...
        switch(idSite) {
            ...
            case 1 :
                ...
                infoSite = new Site((short)1, "Musée Georges-Labit", coordSite, 10, 18, "description", "adresse", "telephone");
                break;
            //Museum histoire naturelle    
            case 2 :
                coordSite = new Coordonnees((float)43.5943, (float)1.44924);
                infoSite = new Site((short)2, "Muséum de Toulouse", coordSite, 10, 18, "description", "adresse", "telephone");
                break;
            //Saint Raymond
            case 3 :
                coordSite = new Coordonnees((float)43.6078, (float)1.44086);
                infoSite = new Site((short)3, "Musée Saint-Raymond", coordSite, 10, 18, "description", "adresse", "telephone");
                break;
        }
        return infoSite;
