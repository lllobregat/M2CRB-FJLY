...
public final class Site implements org.omg.CORBA.portable.IDLEntity
{
     ...
     * Struct member coord
     */
    public GestionAssitanceTouristique.Coordonnees coord;
     ...
     */
    public Site(String nom, GestionAssitanceTouristique.Coordonnees coord, int affluenceCourante, int horaireFermeture)
    {
        this.nom = nom;
        this.coord = coord;
