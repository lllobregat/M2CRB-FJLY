...
public class SiteTouristiqueHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, GestionAssitanceTouristique.SiteTouristique t)
    {
     ...
     */
    public static GestionAssitanceTouristique.SiteTouristique extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return GestionAssitanceTouristique.SiteTouristiqueHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:GestionAssitanceTouristique/SiteTouristique:1.0";
     ...
     */
    public static GestionAssitanceTouristique.SiteTouristique read(org.omg.CORBA.portable.InputStream istream)
    {
        return(GestionAssitanceTouristique.SiteTouristique)istream.read_Object(GestionAssitanceTouristique._SiteTouristiqueStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, GestionAssitanceTouristique.SiteTouristique value)
    {
