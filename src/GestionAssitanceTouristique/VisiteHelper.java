...
public class VisiteHelper
{
    ...
    {
        a.insert_Streamable(new GestionAssitanceTouristique.VisiteHolder(t));
    }
    ...
    public static GestionAssitanceTouristique.Visite extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof GestionAssitanceTouristique.VisiteHolder)
                    return ((GestionAssitanceTouristique.VisiteHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            GestionAssitanceTouristique.VisiteHolder h = new GestionAssitanceTouristique.VisiteHolder(read(a.create_input_stream()));
    ...
    private final static String _id = "IDL:GestionAssitanceTouristique/Visite:1.0";
    ...
    {
        GestionAssitanceTouristique.Visite new_one = new GestionAssitanceTouristique.Visite();

        new_one.date = istream.read_long();
