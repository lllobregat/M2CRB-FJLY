        ...
        implements SmartphoneTouriste
{
    ...
    private final static Class _opsClass = GestionAssitanceTouristique.SmartphoneTouristeOperations.class;
    ...
    public short idCarteAchetee()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if (_so == null)
                   continue;
                GestionAssitanceTouristique.SmartphoneTouristeOperations _self = (GestionAssitanceTouristique.SmartphoneTouristeOperations) _so.servant;
                try
                {
        ...
        while(true)
        {
            if (!this._is_local())
            {
                ...
                try
                {
                    ...
                    GestionAssitanceTouristique.VisiteHelper.write(_output,visite);
                    GestionAssitanceTouristique.SiteHelper.write(_output,site);
                    _input = this._invoke(_output);
                    return;
                }
