...
public class t_listeSitesHelper
{
    ...
    {
        a.insert_Streamable(new GestionAssitanceTouristique.t_listeSitesHolder(t));
    }
    ...
    public static GestionAssitanceTouristique.Site[] extract(org.omg.CORBA.Any a)
    {
        ...
        if(HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof GestionAssitanceTouristique.t_listeSitesHolder)
                    return ((GestionAssitanceTouristique.t_listeSitesHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            GestionAssitanceTouristique.t_listeSitesHolder h = new GestionAssitanceTouristique.t_listeSitesHolder(read(a.create_input_stream()));
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            ...
            _tc = orb.create_alias_tc(id(),"t_listeSites",orb.create_sequence_tc(0,GestionAssitanceTouristique.SiteHelper.type()));
        }
        return _tc;
    }
    ...
    private final static String _id = "IDL:GestionAssitanceTouristique/t_listeSites:1.0";
    ...
    {
        GestionAssitanceTouristique.Site[] new_one;
        {
        int size7 = istream.read_ulong();
        new_one = new GestionAssitanceTouristique.Site[size7];
        for (int i7=0; i7<new_one.length; i7++)
         {
            new_one[i7] = GestionAssitanceTouristique.SiteHelper.read(istream);
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, GestionAssitanceTouristique.Site[] value)
    {
        ...
        {
            GestionAssitanceTouristique.SiteHelper.write(ostream,value[i7]);
