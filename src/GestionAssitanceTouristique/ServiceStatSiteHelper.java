...
public class ServiceStatSiteHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, GestionAssitanceTouristique.ServiceStatSite t)
    {
     ...
     */
    public static GestionAssitanceTouristique.ServiceStatSite extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return GestionAssitanceTouristique.ServiceStatSiteHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:GestionAssitanceTouristique/ServiceStatSite:1.0";
     ...
     */
    public static GestionAssitanceTouristique.ServiceStatSite read(org.omg.CORBA.portable.InputStream istream)
    {
        return(GestionAssitanceTouristique.ServiceStatSite)istream.read_Object(GestionAssitanceTouristique._ServiceStatSiteStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, GestionAssitanceTouristique.ServiceStatSite value)
    {
