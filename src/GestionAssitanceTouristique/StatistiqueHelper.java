...
public class StatistiqueHelper
{
    ...
    {
        a.insert_Streamable(new GestionAssitanceTouristique.StatistiqueHolder(t));
    }
    ...
    public static GestionAssitanceTouristique.Statistique extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof GestionAssitanceTouristique.StatistiqueHolder)
                    return ((GestionAssitanceTouristique.StatistiqueHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            GestionAssitanceTouristique.StatistiqueHolder h = new GestionAssitanceTouristique.StatistiqueHolder(read(a.create_input_stream()));
    ...
    private final static String _id = "IDL:GestionAssitanceTouristique/Statistique:1.0";
    ...
    {
        GestionAssitanceTouristique.Statistique new_one = new GestionAssitanceTouristique.Statistique();
