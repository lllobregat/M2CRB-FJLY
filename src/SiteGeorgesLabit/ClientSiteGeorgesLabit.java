 ...
 * @author Lydia
 */
public class ClientSiteGeorgesLabit extends javax.swing.JFrame {
    ...
    private void jFormattedTextFieldDateStatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFormattedTextFieldDateStatActionPerformed
        String nomServiceStat = ServeurStatSiteGeorgesLabit.nomServiceStatSite;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientSiteGeorgesLabit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        try {
            ...
            new ClientSiteGeorgesLabit().setVisible(true);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
