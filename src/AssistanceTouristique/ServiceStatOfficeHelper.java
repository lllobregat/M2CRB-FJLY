...
public class ServiceStatOfficeHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, AssistanceTouristique.ServiceStatOffice t)
    {
     ...
     */
    public static AssistanceTouristique.ServiceStatOffice extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return AssistanceTouristique.ServiceStatOfficeHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:AssistanceTouristique/ServiceStatOffice:1.0";
     ...
     */
    public static AssistanceTouristique.ServiceStatOffice read(org.omg.CORBA.portable.InputStream istream)
    {
        return(AssistanceTouristique.ServiceStatOffice)istream.read_Object(AssistanceTouristique._ServiceStatOfficeStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, AssistanceTouristique.ServiceStatOffice value)
    {
